...
def market_pipeline():
    ...
    run_command = BashOperator(task_id='dbt_run',
                                bash_command='dbt run --profiles-dir /opt/airflow/dbt/market_data --project-dir /opt/airflow/dbt/market_data',
                               retries=3)
    test_command = BashOperator(task_id='dbt_test',
                                bash_command='dbt test --profiles-dir /opt/airflow/dbt/market_data --project-dir /opt/airflow/dbt/market_data',
                                retries=3)
    stocks_task = stocks()
    crypto_task = crypto()
